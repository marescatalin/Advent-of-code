...
describe('.getEndCoordinate', () => {
    it('Get coordinates down', () => {
        ...
        expect(coords).to.eql(expectation)
    })

    it('Get coordinates right', () => {
        var day3 = new Day3(`R98,U47\nR26,D63`)
        var coords = day3.getEndCoordinate(new Coordinates(2, 3), new Location("R", 3))
    ...
    it('Get coordinates up', () => {
        var day3 = new Day3(`R98,U47\nR26,D63`)
        var coords = day3.getEndCoordinate(new Coordinates(2, 3), new Location("U", 5))
